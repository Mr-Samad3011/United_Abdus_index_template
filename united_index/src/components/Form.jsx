...
//   /* =========================== UPDATED PDF GENERATE (Single Page, Border Included) =========================== */
//   const generatePDF = async () => {
//     const element = document.getElementById("pdf-content");
//     if (!element) return alert("PDF layout not found!");

//     // Capture canvas with borders included
...
//     // Scale image to fit page with small margin
//     const margin = 5; // 5mm margin
//     const imgWidth = pdfWidth - margin * 2;
//     const imgHeight = (canvas.height * imgWidth) / canvas.width;

//     // Center vertically if content smaller than page
...
//   return (
//     <div className="form-index mt-10">
//       <h2 className="text-5xl font-bold text-center text-blue-700 mb-10 studentheading">
//         📘 Student Information Form
//       </h2>

//       <div className="Form-Page bg-white shadow-xl rounded-3xl p-10 border border-gray-200">
//         <form onSubmit={handleSubmit}>
//           {/* --- INSTITUTE DETAILS --- */}
//           <h3 className="section-title">🏫 Institute Details</h3>
//           <div className="Field">
//             <label>Select College</label>
//             <select name="selectedCollege" value={form.selectedCollege} onChange={handleChange}>
...
//             <select name="affiliatedBy" value={form.affiliatedBy} onChange={handleChange}>
...
//           {/* --- STUDENT DETAILS --- */}
//           <h3 className="section-title mt-8">👨‍🎓 Student Information</h3>
//           <div className="Field">
//             <label>Name</label>
//             <input
//               type="text"
...
//           {/* --- COURSE & SUBJECT --- */}
//           <h3 className="section-title mt-8">📚 Course & Subject</h3>
//           <div className="Field">
...
//             <input name="subjectName" value={form.subjectName} onChange={handleChange} />
//           </div>

//           <div className="Field">
//             <label>Subject Code</label>
//             <input name="subjectCode" value={form.subjectCode} onChange={handleChange} />
//           </div>

//           {/* --- WORK TYPE & TEACHER --- */}
//           <h3 className="section-title mt-8">📝 Work Type & Teacher</h3>
//           <div className="Field">
//             <label>Work Type</label>
//             <div className="radio-group">
//               <label>
//                 <input type="radio" name="workType" value="Assignment" checked={form.workType === "Assignment"} onChange={handleChange} />
//                 Assignment
//               </label>
//               <label>
//                 <input type="radio" name="workType" value="Lab File" checked={form.workType === "Lab File"} onChange={handleChange} />
//                 Lab File
//               </label>
//             </div>
//           </div>
...
//             <input name="teacherName" value={form.teacherName} onChange={handleChange} />
//           </div>

//           {/* --- BUTTONS --- */}
//          <div className="text-center mt-12 flex gap-12 justify-center buttons"> {/* increased gap from 6 to 12 */}
//   <button
//     disabled={isFormIncomplete}
//     type="submit"
//     className={`px-16 py-6 text-white font-bold rounded-2xl shadow-lg 
//       ${
//         isFormIncomplete
...
//     onClick={resetForm}
//     type="button"
//     className="px-16 py-6 bg-red-600 text-white font-bold rounded-2xl shadow-lg hover:bg-red-700 active:scale-95 min-w-[180px] transition-all duration-200"
//   >
//     Reset
//   </button>
// </div>
...
//             <button
//               onClick={generatePDF}
//               className="px-8 py-3 bg-green-600 text-white rounded-xl shadow hover:bg-green-700"
//             >
//               📄 Download PDF
//             </button>
//           </div>
